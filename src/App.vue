  ...
  <div id="app">
    ...
    <header id="home">
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                ...
                <a class="navbar-brand" href="#">COD<span>ECRAF</span>TERZ</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <!-- // Caption // -->
                        <div class="caption">
                            <h1>Make WORK Easy With CODECRAFTERZ.</h1>
                            <p class="sub">Donec quam felis, ultricies nec, pellentesque eu, pretium quis sem.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 wow bounceIn" data-wow-duration=".5s" data-wow-delay=".2s">
                    ...
                    <!-- / Caption / -->
                    <p>Unlike team chat apps, CODECRAFTERZ is designed to help your team stay focused by keeping relevant and actionable.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 wow fadeInLeft" data-wow-duration=".5s" data-wow-delay=".2s">
                    <h3>Powerful services for Powerful applications.</h3>
            ...
            <div class="row seconde">
                <div class="col-md-7 wow fadeInLeft" data-wow-duration=".5s" data-wow-delay=".2s">
                    <img src="imgs/updates.jpg" class="img-fluid" alt="update">
                </div>
                <div class="col-md-5 wow fadeInRight" data-wow-duration=".5s" data-wow-delay=".5s">
                    <div class="caption">
                        <h3>Easily balance workloads and manage resources.</h3>
                        <p>Responsive code that makes your landing page look good on all devices (desktops, tablets, and phones). Created with mobile specialists.</p>
                        <p>Plan ahead by day, week, or month, and see project status at a glance</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 feature wow bounceIn" data-wow-duration=".5s" data-wow-delay=".2s">
                    ...
                    <h4>UI/UX Design</h4>
                    <p>The European languages are members of the same family separate existence.</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 wow fadeInLeft" data-wow-duration=".5s" data-wow-delay=".2s">
                    <div class="price-table">
                        ...
                        <button class="btn btn-transparent" type="button">Sign Up</button>
                    </div>
                </div>
                <!--// First Table // -->
    ...
    <section id="contact">
        <div class="container">
            ...
            <p>&copy; CODECRAFTERZ All Right Reserved</p>
        </div>
    </section>
  </div>
</template>
